...
<?php $currentpage="Delete Favorite";
      include "pages.php";
?>
...
<?php
  ...
  $msg = "Delete Favorite for $username";
  ...
  if(!$username){
  echo "<h2>ERROR: You must be logged in to delete a favorite restaurant.</h2>";
        ...
        // See if user is already in the table
              ...
              // attempt insert query
                ...
                if(mysqli_query($conn, $query)){
                  $msg =  "<p>Favorite successfully deleted.</p>";
                } else{
                  echo "ERROR: Could not execute $query. " . mysqli_error($conn);
                }
        		} else {
                echo "ERROR: You have not favorited that restaurant.";
        		}
        }
      }
...
-->
  <?php
    ...
    echo "      <p>
            <input type = 'submit' class='button-style' value = 'Confirm Delete Favorite for $restName' />
          </p>";
  ?>
